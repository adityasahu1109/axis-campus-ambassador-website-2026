...
function AdminDashboard() {
  ...
  // --- MODIFICATION: Updated handleCreate ---
  const handleCreate = async (e, type) => {
    ...
    try {
      if (type === 'task') {
        ...
        // 2. Automatically create an announcement for the task
        ...
        if (announceError) {
          // Log this error, but don't stop the flow. The task was created.
      ...
      fetchData(); // Refreshes all data, including tasks and announcements
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="mt-8 flex justify-center p-1.5 space-x-1 sm:space-x-2 bg-slate-100 dark:bg-slate-800/80 rounded-lg border border-slate-200 dark:border-slate-700">
